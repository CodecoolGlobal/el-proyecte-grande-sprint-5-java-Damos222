...
@DataJpaTest
class AccommodationRepositoryFindByAddress_CountryTest {
    @Autowired
    ...
    @Test
    void findAccommodationsByAddress_Country() {
    }

    @Test
    void findAccommodationsByCapacityGreaterThanEqual() {
    }

    @Test
    void findAccommodationsByCapacityLessThanEqualAndCapacityGreaterThanEqual() {
    }

    @Test
    void findAccommodationsByPricePerNightBetween() {
    }

    @Test
    void findAccommodationsByType() {
    }
}